...
import {Title} from "@/shared/components/shared/UiComponents/Title";
...
export const Categories: React.FC<Props> = ({className, loading, categories}) => {
  ...
  if (loading) {
    return (
        <Skeleton
            className="flex items-center justify-center text-white bg-primary h-10 w-[600px] opacity-0.5 rounded-2xl">
